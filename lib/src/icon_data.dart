...
final class FaDuotoneIconData {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is FaDuotoneIconData && other.primary == primary && other.secondary == secondary;
  }
  ...
  @override
  String toString() => 'FaDuotoneIconData(primary: $primary, secondary: $secondary)';
}
